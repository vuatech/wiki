...
description: 
published: true
date: 2024-01-23T02:45:56.927Z
tags: 
editor: markdown
dateCreated: 2024-01-23T01:22:02.039Z
---

# OpenMandriva Release Plan and Repositories

Avant d'effectuer un changement dans les canaux, si vous n'êtes pas sûr de vous n'hésitez pas à contacter l'équipe OpenMandriva directement via le forum ou le chat.

## Publication
Une publication est un ensemble de paquets de logiciels mis en coffret pour former un système d'exploitation. Chaque parution à sa propre version, comme *Mandriva 2009*, *Windows XP*, *OpenMandriva Lx 2014*, *OpenMandriva Lx 4.2*, ect.
Les versions sont aussi appelées *Canaux de mises à jour*.
Release, Rock, Rolling et Cooker sont toutes des versions différentes (canaux séparés) d'OpenMandriva Lx. L'important à retenir est la version car **les différentes versions ne doivent pas être mélangées**.
