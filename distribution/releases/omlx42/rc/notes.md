...
> Warning: This is a development product, and it is not aimed to be used in a production environment. It is released for testing and bug hunting. It may have problems. If you download and test this product, please report your findings and problems at the [Forum](http://forum.openmandriva.org/) or at our [Issue Tracking system](http://issues.openmandriva.org/).
{.is-warning}
