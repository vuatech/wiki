...
Many users may find it more convienient to use the dkms verion of nvidia driver packages. With dkms new kernel modules are built when a new kernel is installed automatically. Currently these only install from Konsole (terminal). To install:
